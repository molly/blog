...
But where do these numbers come from? Is each cryptocurrency project sitting on a bank account with actual dollar bills to match their supposed market cap? Of course not. Even the crypto tokens that *do* claim to be doing this aren't doing this.[^fn1] It's clear there isn't a real dollar in the crypto ecosystem for each reported dollar of market cap, but beyond that, it doesn't even seem to be close.[^fn2] It has also become painfully clear that market capitalization and actual value produced by an enterprise are uncorrelated when it comes to crypto. But even *if* an organization wanted to promise token holders that it would do something useful, increase in valuation as a result, and thus provide returns back to them, that would be a problem. Most crypto groups do everything they can to avoid that type of structure because it puts them right in the crosshairs of the SEC, which requires registration from groups raising money from the public in exchange for intended returns.
...
If we imagine I did find a buyer for my 999,999 MOLLY and I make out like a bandit, that buyer now finds themselves in a tough situation. They paid me $999,999 for my tokens, and I happily sold them. Their crypto trading app shows them they hold 999,999 MOLLY worth $999,999, and they might be happy with that too. But in a week when they check back in on their purchase and see that it hasn't generated any returns, they might find themselves in a tough spot: trying to sell all of these tokens that have no *liquidity*. No matter what the price is, in order for someone to be a seller there must be a buyer, and that is not always the case with crypto.

The recent token transfers pages on blockchain explorers like Etherscan or BSCScan show a neverending stream of trades of often bizarrely named and extremely illiquid new coins like "CatKingToken" ($2,200 liquidity),  "Doge World Cup" ($0 liquidity), and "SpaceDogezilla" ($8,060 liquidity). There are some who like to try to pick the next shitcoin to "moon" like Shiba Inu or Dogecoin once did, hoping that one early, against-all-odds gamble will pay back massive returns. Most of the time they wind up with worthless tokens they couldn't sell at all, much less for near what they paid for them.
...
Even the most popular and liquid cryptocurrencies can experience chaos around large enough sales, even if the overall token price is not significantly affected. In June, a crypto whale suddenly traded 93,000 ETH (around $112 million) for various stablecoins, emptying much of the liquidity pool on the top decentralized exchange, Uniswap, and causing the ETH price on that exchange to plummet to $950 in a "flash crash".[^fn7] Ethereum is the token with the second-largest market cap on CoinMarketCap.

Also in June, the DAO behind the Solana lending platform Solend had to decide whether to take emergency action to avoid the sudden automatic sale of some of the Solana collateral that would occur if the token price dropped low enough. The impending liquidation of 20% of the whale's position, or 1.14 million SOL (~$21 million at liquidation price), was enough to concern Solend members that "it'd be difficult for the market to absorb such an impact", and that it could even threaten the network's stability. Amy Castor wrote, "Make no mistake: this was an exit, not a loan. The whale essentially *sold* a huge amount of SOL for two highly liquid assets — at a substantial discount, granted, but that amount of SOL would have crashed the market otherwise." Solana ranks #9 on CoinMarketCap's list.

### Wash trading

Wash trading is so common in crypto that the CEO of the world's largest crypto exchange apparently forgot it was illegal recently.[^fn8] It is particularly prevalent than with NFTs, where some marketplaces outright encourage the behavior.[^fn9] When someone wash trades an NFT, they sell it between wallets they control, or wallets controlled by co-conspirators, for increasing amounts to try to mimic organic demand. At the end of it all, they have an NFT that's "worth" considerably more than when they started, despite no real person actually being willing to pay more for it. Sometimes the new pricetag alone is enough to artificially create demand and sometimes it's not, but it quite often appears to be more than sufficient to trick journalists for publications like the *New York Times*[^fn10] into reporting on "record-breaking" NFT sales—and *that* often accomplishes wash traders' goals of driving attention to the project.[^fn11] Media outlets also eagerly run headlines on celebrities and influencers "buying" NFTs, only for researchers to discover a web of transactions that suggest they're quietly being paid to promote NFT projects as though they are authentically interested—in violation of FTC rules, by the way.[^fn12]
...
When NFTs are stolen, large numbers are thrown around without any clarity as to whether they are prices paid by the victims for the NFTs, the prices netted by the thiefs when flipping them, the floor prices, or some other value.
...
Crypto exchanges and trackers should be clear about how market caps are being calculated—namely, which are being extrapolated only from trades against other cryptos, and essentially double-counted. They also need to be clearer about the enormous margins of error in their calculations: the entire market cap of crypto is represented on CoinMarketCap down to a tenth of a cent, despite anywhere near that level of precision being impossible.
