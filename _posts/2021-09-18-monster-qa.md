...
<p>The transcript has only been edited for readability (e.g., to remove filler words which do not change meaning) and to remove some of weev's comments (all removals marked inline) which I have no interest in reprinting on my own website. Where relevant and possible, comments from the live chat section have been transcribed for context.</p>

All additional copyright to this transcript can be considered waived, and it can be freely reused with or without attribution to me. Source copyright details are available at the YouTube and SoundCloud links.
</details>
</div>
...
<span class="transcript-speaker">Unidentified:</span> He was also in the [KKK](https://en.wikipedia.org/wiki/Ku_Klux_Klan).[^fn21]
...
<span class="transcript-speaker">Kirtaner:</span> I'm actually shocked that he showed up, because weev has kind of been hidden for the past couple years.

<span class="transcript-speaker">Unidentified:</span> He's like an enigma.

<span class="transcript-speaker">Monster, SC3:33:26:</span> That's kind of what I think about that. The thing is, if you can get to the place where you don't lose your cool when you're dealing with people that are not deserving, necessarily, of your compassion, I think that you'll find that that really does bless you and grow you as a person. I think it really is a very useful exercise to get to a place where you're rooted and grounded in enough operating tenets that you can deal with people who think differently than you, and sometimes maybe are not very evolved. Because they still are very much governed by their carnal thoughts, so to speak. And still have a rational conversation. We're all on a journey, we really are. I just encourage you, as people who are out there dealing with people who might have different stages in their walk, where you can engage their optimistic, to be optimistic. Engage with them in an enthusiastic way.

<span class="transcript-speaker">Monster, SC3:34:36:</span> Gosh. <span class="transcript-note">[reading the chat]</span> Have I ever had a low-paying job? Yes, I have. I have had a low-wage job. Growing up, I'll tell you. Funny story. My mother's father, in the Netherlands, had three daughters. My mother was the oldest daughter. And my grandfather, who was a farmer in northern Holland, he had no sons to take over the farm. You know, kind of a paternalistic society, it had been passed down for generations. So at the time I was living in the U.S., my dad was a [Fulbright Scholar](https://en.wikipedia.org/wiki/Fulbright_Program) at [Chase Western Reserve](https://en.wikipedia.org/wiki/Case_Western_Reserve_University). Fulbright Scholars basically get sent to another country to get a degree. So, starting at the age of four, my parents would ship me to the Netherlands for the summer, every summer, to go work on the family farm. I would do things like harvest sweet potatoes for twelve cents a meter, and I loved doing it. I started early, finished late. My grandfather, he paid me as much as he paid the big workers as long as I did the same work. And I respected it. The downside of that was, on the one hand, learning strong work ethic and discipline, physical strength, whatever. <span class="transcript-note">[speaking Dutch]</span> Somebody asked me Dutch. But I really developed a love of money. From a very early age I was very concerned about money and having the ambition to be a millionaire and all that. But I absolutely started from the ground up, my parents really didn't believe in allowances, so I had to basically make it. Guys, I didn't grow up with a silver spoon in my mouth, my... I was born in the [Ronald McDonald House](https://en.wikipedia.org/wiki/Ronald_McDonald_House_Charities). I was the only white kid in the Ronald McDonald House of Cleveland, Ohio. My parents... I was an accident, my parents married young and my mother didn't even know she was pregnant until she was like five months along. My crib was a cardboard box. I was an accident, yep, there you go.

<span class="transcript-speaker">High Fidelity, SC3:37:04:</span> Rob, I mean, even now, it really all comes back to Cleveland, doesn't it?

<span class="transcript-speaker">Monster:</span> Cleveland.

<span class="transcript-speaker">Unidentified:</span> Do you like [Bone Thugs](https://en.wikipedia.org/wiki/Bone_Thugs-n-Harmony)?

<span class="transcript-speaker">High Fidelity:</span> Hell yeah I like Bone Thugs! Bumping that Bone Thugs until I die.

<span class="transcript-speaker">Monster, SC3:37:18:</span> Yeah, it was 1967, and I think at the time there was like race riots going on along Lake Erie in Cleveland.[^fn22] So that was where I grew up. And then we moved to Philadelphia when I was two years old, after my sister was born. And then my third sister was born in '72, two years later. But like I said, at a very early age, I was sent to the Netherlands to work on the family farm, and that was the deal, but I didn't know... My parents would like, take me to the airport, drop me off at the airport, and I would literally be shipped as like a package to the Netherlands, and then my grandparents would meet me when I landed and the stewardess would escort me through the baggage claim to my grandparents. I didn't know any better. I just grew up with maybe a little bit of a different arrangement.

<span class="transcript-speaker">Monster, SC3:38:25:</span> <span class="transcript-note">[reading the chat]</span> Was I poor as a kid? We had enough. My dad was a university professor and he had among the earliest computers, back when computers were like the size of a room. I went to a public school, Elwood Elementary in Philadelphia. I was in the mentally gifted program so we were able to use computers, and so I got an early introduction to computers. Had an [Apple I](https://en.wikipedia.org/wiki/Apple_I) when they came out. [TRS-80](https://en.wikipedia.org/wiki/TRS-80), remember those? They had like a <span class="transcript-note">[unintelligible]</span> cassette tape. So yeah, I grew up with computers. My dad, at some point he became a professor of computer science. So I grew up with computers. I became really fascinated with the idea that computers could be used as a force for good, and that it would be very important to know tech. Back when I was finishing my undergraduate and MBA at [Cornell](https://en.wikipedia.org/wiki/Cornell_University), I was recruited by [Procter & Gamble](https://en.wikipedia.org/wiki/Procter_%26_Gamble), and they wanted to recruit me to go work for them in Cincinnati. And I was like, "no, I really want to work in Europe and I really want to work in I.T." Because at the time they wanted to send me off to do brand management in Cincinnati. And I said, "look, it's Europe or nothing". This was right at the time of the European Union, 1992. They came back to me the next day, made me an offer, and I moved to Frankfurt. I stayed out there for four years and then my boss got transferred to Japan, he asked if I wanted to follow him, and by that time I was a global product manager for the Pampers brand of baby diapers. And was now working as an expatriate for five years, traveling all over the world. And the last year I was at P&G, the last full year, 1998, I racked up a million frequent flyer miles in a single year, as a worldwide manager doing consumer research all over the world. It was nuts.

<span class="transcript-speaker">High Fidelity:</span> Didn't you have kids while you were doing all this traveling, Rob?
...
<span class="transcript-speaker">High Fidelity, SC3:42:05:</span> So what I found out is you can collect data on like a shitload of people. And then you can build [psychographic](https://en.wikipedia.org/wiki/Psychographics) profiles of them, and then you can use those psychographic profiles to mess with their heads and make them do stuff.

<span class="transcript-speaker">Monster:</span> Yeah, no, so there's... in the market research world you talk about, like, psychographic, demographic, and... I think ultimately, one of my early bosses... I had a couple of Scottish bosses. And they had a philosophy that I think was right, which is, they had the attitude that said "first figure out the truth and then explain truth", right? With enough market research data you can make the data say whatever you want, to a certain extent. And I think that using good market research in a responsible way, you can change strategies in a way that the data tells the story as opposed to basically debating peoples' opinion and gut. And so like it has a purpose. But there are also people in this day and age, and I'm sure some of you are more knowledgeable about this than I am, that have evolved that to a point where you have very comprehensive, progressive profiles of a large number of people who never opted in to be profiled. And the technology allows them to be manipulated through stimuli that's designed to brigade them towards particular outcomes. I wish it would be used in an entirely benevolent way, but I'm sure that it's not.

<span class="transcript-speaker">High Fidelity, SC3:43:50:</span> So how do you stop this? I was actually talking to a friend of mine and we kind of think that there needs... I don't know. It's hard, because you don't want to limit what people run their mouths about, but at the same time you've got people getting killed over Internet, Twitter spats. Right? You have [police being sent to peoples' houses in the middle of the night like a SWAT team](https://en.wikipedia.org/wiki/Swatting). And people are dying from it. You gotta draw a line somewhere, man.

<span class="transcript-speaker">Unidentified:</span> If I may ask, is... this is not a new thing, is it? I'm trying to be sarcastic, it's not working. But this has been around for eighteen something years, sixteen something years?

<span class="transcript-speaker">High Fidelity:</span> Yeah, since the Internet's been around.

<span class="transcript-speaker">Unidentified:</span> Yeah, so why act as if it's a modern thing?

<span class="transcript-speaker">High Fidelity:</span> So how do you handle that? There needs to be some regulation. Should regulation be done on the vendor side? Should it be done... <span class="transcript-note">[crosstalk]</span>

<span class="transcript-speaker">Monster, SC3:44:45:</span> Yeah, I'm glad you asked. Earlier I made a mention of this project called Valido. The single sign-on. Part of the idea with Valido is combining [self-sovereign identity](https://en.wikipedia.org/wiki/Self-sovereign_identity) with portable [reputation](https://en.wikipedia.org/wiki/Reputation_system) and the ability to have granular control over who knows what about you and for how long, in a way whereby you have the ability to revoke that access. And it's a really obvious idea in that, if you look at the development that are out there, of the big [OAuth](https://en.wikipedia.org/wiki/OAuth) projects, a lot of them are basically corporate-first, right? [Okta](https://en.wikipedia.org/wiki/Okta) is basically the case study of that. You have, essentially, a corporate-centric approach to identity management. But there's no framework for portable identity from a single sign-on perspective where the user is sovereign in their control over who knows what about them and for how long, and where they're getting paid by the advertisers for basically observing stimuli that they may or may not be interested in. So I think Valido is a really interesting project. It looks at aspects like bonded sender, so like if you want to send somebody a message and they didn't want to receive it, it was a spam, then it will cost you a token. So you can build a [token economy](https://en.wikipedia.org/wiki/Token_economy) around attention whereby it costs a nominal amount of tokens to be able to deliver a stimuli to an individual who says "I don't want to be bothered". So a high-stakes person that doesn't want to be overwhelmed with stimuli can basically set their bar as to how many uninvited stimuli will they be willing to accept. 

<span class="transcript-speaker">High Fidelity:</span> Why wouldn't people just set it up for maximum "don't bother me"?

<span class="transcript-speaker">Monster, SC3:46:36:</span> Yeah, right, exactly. So if you don't want to be bothered, you set your threshold really high, and nobody unless they really, really, really needed to be able to get ahold of you, they would be able to send you a message. And that means the end of spam. So, we'll see. But, that's one of our high-priority projects and I'm excited to see it come together. I think what it does is it opens up the possibility of creating a level playing field, where you don't have to be a huge company to be able to get people to sign up for your little website. Because one of the big challenges for independent publishers is how do you give them a way to be able to get audience when most people don't want to sign up and save [PII](https://en.wikipedia.org/wiki/Personal_data) with a small website that they may use once and not again. So the framework for portable, [self-sovereign identity](https://en.wikipedia.org/wiki/Self-sovereign_identity) with [single sign-on](https://en.wikipedia.org/wiki/Single_sign-on) and portable [reputation](https://en.wikipedia.org/wiki/Reputation_system), where you have the ability to basically... it pays to be you and it pays to be good... I think it's an idea that's time has come, and so yeah... <span class="transcript-note">[reading the chat, not visible]</span> Yeah, there's mature tech but it hasn't been implemented from a consumer-centric perspective, so we'll see.
...
<span class="transcript-speaker">Unidentified, SC3:52:11:</span> I was just gonna say... Kirt off in the background having his eyes bug out because he's donated like 400 cats to adoption shelters.
...
<span class="transcript-speaker">Kirtaner, SC3:57:50:</span> And thank you. Thank you again for taking down YourDaddyJoey. I appreciate that myself.
...
[^fn21]: Some biographers have said that Pike was a high-ranking [Ku Klux Klan](https://en.wikipedia.org/wiki/Ku_Klux_Klan) member, though one has questioned whether Pike was a member of the Klan. He did, however, propose creating a secret society to "unite every white man in the South, who is opposed to negro suffrage, into one great Order of Southern Brotherhood". ([Albert Pike](https://en.wikipedia.org/w/index.php?title=Albert_Pike&oldid=1043317490). Wikipedia, September 23, 2021)
[^fn22]: Possibly referring to the [Hough riots](https://en.wikipedia.org/wiki/Hough_riots) in 1966 in Cleveland.