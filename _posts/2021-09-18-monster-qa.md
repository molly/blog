...
<span class="transcript-speaker">Monster, 1:48:57</span> <span class="transcript-note">[reading chat. Full comment in chat was from "nf84": "It's in here https</span>//www.epik.com/terms. There's a headline 'Acceptable Use'"]</span>. "Acceptable use policy..." Yeah, if you guys think there's something wrong with our acceptable use policy, drop me a note, rob@epik.com, and we'll take a look at that.
